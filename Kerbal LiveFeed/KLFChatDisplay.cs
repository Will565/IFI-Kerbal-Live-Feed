...
namespace KLF
{
	class KLFChatDisplay
	{
		...
		public const float WINDOW_WIDTH_NORMAL = 300;
		public const float WINDOW_WIDTH_WIDE = 500;
		public const float WINDOW_HEIGHT = 360;
		public const int MAX_CHAT_OUT_QUEUE = 4;
		public const int MAX_CHAT_LINES = 100;
		public const int MAX_CHAT_LINE_LENGTH = 200;
		public const float NAME_COLOR_SATURATION_FACTOR = 0.55f;
