...
abstract class Client
{
	...
	public const int MAX_TEXT_MESSAGE_QUEUE = 256;
	public const long KEEPALIVE_DELAY = 2000;
	public const long UDP_PROBE_DELAY = 2000;
	public const long UDP_TIMEOUT_DELAY = 30000;
	...
	public const long PING_TIMEOUT_DELAY = 15000;

	public const int INTEROP_WRITE_INTERVAL = 100;
	public const int INTEROP_MAX_QUEUE_SIZE = 225;

	public const int MAX_QUEUED_CHAT_LINES = 8;
	public const int MAX_CACHED_SCREENSHOTS = 20;
